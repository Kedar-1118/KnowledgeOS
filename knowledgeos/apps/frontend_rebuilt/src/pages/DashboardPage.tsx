...
export default function DashboardPage() {
  ...
  const isSyncing = syncStatus?.isRunning || syncMutation.isLoading
  ...
  return (
    <div className="space-y-6 select-none">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-lg">
        <div className="glass-panel p-lg rounded-xl flex flex-col gap-sm group hover:border-primary/50 transition-colors">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-lg items-stretch">
        <section className="xl:col-span-4 glass-panel p-xl rounded-xl flex flex-col items-center justify-center gap-lg">
          ...
          <div className="relative w-48 h-48 flex items-center justify-center">
            <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
              ...
              <circle
                ...
                strokeLinecap="round"
                strokeWidth="8"
                style={{ strokeDasharray: '251.32', strokeDashoffset: strokeDashoffset }}
              ></circle>
            </svg>
            <div className="absolute inset-0 flex flex-col items-center justify-center leading-none">
              <span className="font-display-lg text-display-lg text-on-surface text-3xl font-bold">{healthRatio}%</span>
        ...
        <section className="xl:col-span-8 glass-panel rounded-xl overflow-hidden flex flex-col justify-between">
          <div>
            ...
            {isRecentLoading ? (
              <div className="p-lg space-y-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="skeleton h-10 w-full bg-white/5 rounded-lg animate-pulse" />
                ))}
              </div>
                      ...
                      <tr key={doc.id} className="hover:bg-white/5 transition-colors group">
                        ...
                        <td className="p-lg">
                          <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-bold tracking-widest uppercase ${
                            ...
                            doc.status === 'PROCESSING' ? 'bg-primary/20 text-primary animate-pulse' :
      ...
      {isSyncing && (
        <div className="fixed bottom-10 right-10 w-64 glass-panel rounded-xl p-md border border-primary/20 shadow-xl z-30 flex flex-col gap-sm animate-fade-in bg-surface-container-lowest">
          <div className="flex items-center justify-between">
