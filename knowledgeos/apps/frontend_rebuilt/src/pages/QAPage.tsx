...
export default function QAPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-100px)] overflow-hidden rounded-xl border border-outline-variant/30 glass-panel select-none relative">
      {/* Left Chat Screen */}
        ...
        <div className="flex-1 overflow-y-auto p-gutter custom-scrollbar space-y-xl" id="chat-container">
          {messages.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-6 text-on-surface-variant max-w-md mx-auto">
              <span className="material-symbols-outlined text-4xl mb-4 text-primary">smart_toy</span>
        ...
        <div className="p-gutter border-t border-outline-variant bg-surface-container-lowest/50">
          <div className="max-w-3xl mx-auto relative glass-panel rounded-xl p-2 focus-within:ring-2 focus-within:ring-primary/20">
            <div className="flex flex-col">
              <textarea
                ref={textareaRef}
                className="w-full bg-transparent border-none text-xs p-md focus:ring-0 resize-none max-h-24 text-on-surface outline-none"
      ...
      {/* Right Drawer Citations */}
      <aside className="w-[360px] bg-surface-container border-l border-outline-variant flex flex-col overflow-hidden h-full">
